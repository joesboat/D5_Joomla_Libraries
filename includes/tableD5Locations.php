...
class table_D5locations extends USPStableAccess{
...
function __construct($db, $caller=''){
	...
	parent::__construct('locations', $db, $caller);
...
//*********************************************************
function getLocationName($location_id, $link = 0){
	$location = $this->get_record('location_id',$location_id);
	if (! $location) return "";
	$str = '';
